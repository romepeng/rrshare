...
from rrshare.rqUtil import rq_util_get_trade_range, is_before_tradetime_secs_cn

from rrshare.rqUtil import (rq_util_date_str2int,rq_util_date_int2str,is_tradeday_and_market_opened,
                            rq_util_date_today, trade_date_sse,is_tradeday_and_market_opened,
                            rq_util_get_last_tradedate)
from rrshare.rqFetch import (pro,fetch_delist_stock, fetch_get_stock_list)
from rrshare.rqUtil import PERIODS
...
def fetch_stock_day_adj_fillna_from_tusharepro(trade_date=startDate):
...
def fetch_realtime_price_stock_day_adj(src='sina'):
    ...
    trade_date = rq_util_date_today() if is_tradeday_and_market_opened() else  rq_util_get_last_tradedate()
    #print(trade_date)
